...
const Index = () => {
  ...
  const { data, date, loading, lastRefresh, refresh } = useRSIData(60000, intervalMinutes);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <footer className="border-t border-border py-4 text-center text-xs font-mono text-muted-foreground">
        Simulated data for {date} • RSI MA length 21 • {intervalMinutes}min candles • Auto-refresh every 60s
      </footer>
    </div>
  );
};
